<template>
  <v-main class="fill-height pa-xs-0 d-flex align-center" height="100%">
    ...
    <v-card class="pa-sm-auto mx-auto pa-xs-0 ma-xs-0" max-width="1024">
      <v-row no-gutters>
        <v-col xs="12" sm="12" md="5" lg="5" xl="5" class="hidden-sm-and-down d-flex flex-column justify-end align-center py-16" justify="center" style="background-color: #0D47A1">
          <div class="px-sm-16">
