        ...
        <v-col class="white py-8" xs="12" sm="12" md="7" lg="7" xl="7">
          <div align="start" class="pa-12">
            ...
            <div align="center" justify="center">
              <v-btn href="/reset-password" color="#0D47A1" class="px-12 white--text" x-large @click="submit">Tiếp theo</v-btn>
              <router-link :to="'/signin'" class="d-block mt-2 mb-3 text-decoration-none" style="color:#0D47A1">Quay lại đăng nhập</router-link>
            </div>
          </div>
        </v-col>
      </v-row>
